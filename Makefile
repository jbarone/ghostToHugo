...
package: build
	...
	tar -cvzf release/ghostToHugo-Windows-x86_64.tar.gz --directory=dist/windows/amd64 .
	tar -cvzf release/ghostToHugo-Linux-i386.tar.gz --directory=dist/linux/386 .
	tar -cvzf release/ghostToHugo-Windows-i386.tar.gz --directory=dist/windows/386 .
